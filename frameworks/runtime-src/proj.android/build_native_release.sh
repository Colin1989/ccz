...
echo "- copy scripts"
cp -rf "$APP_ROOT"/tools/encode/src "$APP_ANDROID_ROOT"/assets/
echo "- copy resources"
cp -rf "$APP_ROOT"/res "$APP_ANDROID_ROOT"/assets/
cp -rf "$APP_ROOT"/tools/encode/res "$APP_ANDROID_ROOT"/assets/
echo "- copy config"
cp -rf "$APP_ROOT"/config.json "$APP_ANDROID_ROOT"/assets/
# echo - copy updater.zip
# cp -rf "$APP_ROOT"/encode/updater.zip "$APP_ANDROID_ROOT"/assets/res/updater.zip
# echo - copy flist
# cp -rf "$APP_ROOT"/encode/flist "$APP_ANDROID_ROOT"/assets/res/flist
